...
# Load data
df = pd.read_csv(r'C:\Users\aishi\OneDrive\Desktop\c++\athlete_events.csv')
region_df = pd.read_csv(r'C:\Users\aishi\OneDrive\Desktop\c++\noc_regions.csv')
...
# Sidebar radio button for menu selection
...
if user_menu == 'Medal Tally':
    ...
    st.title(f"Medal Tally {'Overall' if selected_year == 'Overall' else 'in ' + str(selected_year) + ' Olympics'}"
             f" {'for ' + selected_country if selected_country != 'Overall' else ''}")
